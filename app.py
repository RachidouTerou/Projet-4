...
if uploaded_file is not None:
    ...
    with col2:
        ...
        st.markdown(f"<div style='display: flex; justify-content: center; align-items: center; height: 100%;'><h5 style='text-align: center;'> pourcentage de sureté: {conf*100:.1f} %</h5></div>", unsafe_allow_html=True)
